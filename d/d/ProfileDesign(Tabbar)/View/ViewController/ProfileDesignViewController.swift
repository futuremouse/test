...
//    }()
    ...
    private func setupProfileView() {
        ...
        self.view.addSubview(clBarImage)
        ...
        NSLayoutConstraint.activate([
            ...
            clBarImage.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 303),
            clBarImage.widthAnchor.constraint(equalToConstant: (view.frame.width - 20) / 3),
    ...
    private func setupCollectionView() {
        ...
        let totalSpacing = layout.minimumInteritemSpacing * 2 // 셀 사이의 총 간격
        let cellWidth = (view.frame.width - totalSpacing) / 3 // 한 셀의 너비

        layout.itemSize = CGSize(width: cellWidth, height: cellWidth) // 가로, 세로 크기 동일
        layout.minimumInteritemSpacing = 2 // 셀 간의 가로 간격
        layout.minimumLineSpacing = 2 // 셀 간의 세로 간격

        collectionView = UICollectionView(frame: CGRect(x: 0, y: 363, width: view.bounds.width, height: cellWidth * 3), collectionViewLayout: layout)
        ...
        if let collectionView = collectionView {
            ...
            NSLayoutConstraint.activate([
                collectionView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 304),
                collectionView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
                collectionView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
                collectionView.heightAnchor.constraint(equalToConstant: cellWidth * 3)
            ])
        }
    }
